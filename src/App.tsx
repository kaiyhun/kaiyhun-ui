/**
 * Design-system preview page (Phase 1 deliverable).
 *
 * A scrollable showcase of the proposed tokens and primitives so the
 * design direction can be reviewed in the browser: palette, type scale,
 * motion primitives (Reveal / RevealGroup / Parallax), and the restyled
 * shadcn components. This page is throwaway — real features replace it
 * once the Phase 2 plan is approved.
 */
...
const SWATCHES = [
  { name: 'background', share: '~65%', className: 'bg-background ring-1 ring-border' },
...
function App() {
  return (
    <>
      ...
      <footer className="border-t border-border px-6 py-12 text-center text-sm text-muted-foreground">
        kaiyhun — design-system preview · Phase 1
      </footer>
    </>
  )
}
